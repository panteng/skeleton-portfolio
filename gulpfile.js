...
// copy javascripts which should not be bundled by 'publish-js' from bower_components to app/dist/javascripts
gulp.task('publish-standalone-js', function () {
    var standaloneJsVendors = vendors.standalone_javascripts;

    return gulp.src(standaloneJsVendors)
        .pipe(gulp.dest('app/dist/javascripts'));
});
...
gulp.task('dev', function (cb) {
    runSequence(['clean-files'], ['publish-fonts', 'publish-images', 'publish-css', 'publish-js', 'publish-standalone-js'], 'inject', 'watch', cb);
});
